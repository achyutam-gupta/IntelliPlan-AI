          ...
          <div className="relative z-10">
            ...
            <div className="mt-10 flex flex-col items-center gap-4 sm:flex-row sm:justify-center">
              <button 
                ...
                className="group relative overflow-hidden flex items-center gap-2 rounded-xl bg-primary px-8 py-4 text-sm font-semibold text-primary-foreground transition-all hover:shadow-2xl hover:shadow-primary/30"
              >
