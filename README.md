...
Phase 1: Ingestion
Open the User Stories Module.
Action: Paste a Jira link (e.g., https://org.atlassian.net/browse/PROJ-123) and click Fetch.
Show the client how the platform instantly synchronizes the ticket description and metadata securely.
Phase 2: Generation
Click Generate User Stories.
Show the client the AI at work. Explain that it is using a strictly formatted template to enforce ISTQB standards.
Review the output: Expand a generated story to show the dynamically created Gherkin criteria (Given/When/Then).
Highlight the "AI Quality Score" metric which evaluates the health of the requirement.
Phase 3: Test Planning
Select the generated stories and click Create Test Plan.
The platform carries the context over to the next phase.
Show the generated Test Plan outline, highlighting how the AI identified "Blast Radius" risks based purely on the context.
Action: Click Export to download the finalized Test Plan as a shareable document.
